...
static boolean handleAdmin(String option, Scanner sc, FTTH ftth,
    ...
    static void doInventory(Scanner sc, FTTH ftth) {
        // System.out.println("\n--- Inventory Admin ---");
        // System.out.println("  [1] View port map (data.txt)");
        // System.out.print("Choose: ");
        // String sub = sc.nextLine().trim();
        // if (sub.equals("1")) {
        //     try (BufferedReader br = new BufferedReader(new FileReader("data.txt"))) {
        //         System.out.println("\nPincode  OLT   SPL   Port  Subscriber");
        //         System.out.println("-".repeat(50));
        //         String line;
        //         while ((line = br.readLine()) != null) {
        //             if (line.startsWith("#") || line.trim().isEmpty()) continue;
        //             String[] p = line.split(",");
        //             System.out.printf("%-8s %-6s %-6s %-5s %-15s%n",
    ...
    static void doCapacity(Scanner sc, FTTH ftth) {
        System.out.println("\n--- Capacity Dashboard ---");
        int[] pincodes = {560001, 560002, 110001};  // extend list as needed
